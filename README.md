...
docker build -t leo-frontend-app .

2. Run the container:
docker run -p 8080:8080 leo-frontend-app

In browser, search up localhost:8080

## Running the Project Locally using Dev Server
...
- [ ] Use github actions to automate deployment to Azure Container App (leo-frontend-app) inside the environment:     leo-env
